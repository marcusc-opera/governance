...
Based on the current market conditions, we propose to allow a maximum of 28,409,100 \$CELO (\$2,840,910 at \$0.10 CELO price) to be claimed in order to guarantee the USD value needed for MiniPay team to accomplish its objectives whatever are the market directions in the next 15 months
